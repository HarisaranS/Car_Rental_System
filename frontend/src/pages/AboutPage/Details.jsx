   ...
   return (
      <div className='flex items-center justify-between flex-col sm:flex-row my-20 gap-y-8'>
         ...
         <div className='basis-[50%] space-y-6'>
            <h1 className='text-3xl sm:text-4xl md:text-5xl font-semibold font-serif'><span className='text-[#960bd2]'>Car Rental System</span></h1>
            ...
            <h2 className='text-xl sm:text-3xl font-semibold text-[#8a54ed]'>+91 9876543210</h2>
