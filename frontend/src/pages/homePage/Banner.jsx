    ...
    return (
        <div className='flex items-center justify-between py-20 flex-col sm:flex-row gap-y-6'>
            <div className='basis-[48%] space-y-6'>
                <div className=' bg-purple-50 w-40 text-center border border-purple-200 py-2 px-4  rounded-full flex items-center space-x-2 '>
            ...
            <div className='basis-[48%]'>
                <img src={banner} alt="Car Banner" className='w-full' />
            </div>
        </div>
    );
};
